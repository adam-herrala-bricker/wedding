...
const text = {
    ...
    photoTxt: { suo: 'Galleran kuvat on ottanut valokuvaajamme Milja Nordgerg. Mainitsethan hänet, jos käytät näitä kuvia jossain. Huomaathan myös, että kuvia ei tule leikata tai editoida millään tavalla.', eng: 'This is a gallery of photos taken by our talented photographer Milja Nordberg. We request that if you use these photos anywhere you credit her. Please also note that as per our agreement with her, the photos should not be cropped or edited in any way.' },
